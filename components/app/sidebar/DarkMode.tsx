...
export default function DarkMode() {
  ...
  return (
    <div onClick={toggleTheme} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-50 hover:bg-gray-200 dark:hover:bg-gray-700 group cursor-pointer">
      {theme == "dark" && (
        <>
