...
export default function Sidebar() {
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-4 shadow-gray-400 shadow-[0_0_2px] overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <ul className="pt-4 mt-4 space-y-2 border-t border-gray-300 dark:border-gray-700">
          <li>
            <a href="/event/add" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
