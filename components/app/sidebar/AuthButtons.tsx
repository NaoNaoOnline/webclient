...
export default function AuthButtons() {
  ...
  return (
    <ul className="pt-4 mt-4 space-y-2 border-t border-gray-300 dark:border-gray-700">
      <li>
        {user && (
          <a href="/api/auth/logout" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
        ...
        {!user && (
          <a href="/api/auth/login" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
