  ...
  return (
    <div className="relative z-0 w-full mb-6">
      ...
      <div className="relative">
        <div className={`absolute py-2 px-0 z-0 text-sm bg-transparent appearance-none ${fcsd || stld ? "text-gray-900 dark:text-gray-50 " : "text-gray-500 "}`}>
          https://
        </div>
        <input
          type={props.type}
          ...
          pattern={props.ptrn}
          title={props.titl}
          className="relative block z-10 py-2 pl-12 pr-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-50 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
