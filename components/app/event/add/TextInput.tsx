  ...
  return (
    <div className="relative z-0 w-full mb-6">
      ...
      <input
        ...
        pattern={props.ptrn}
        title={props.titl}
        className="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-50 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
