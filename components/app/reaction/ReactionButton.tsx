  ...
  return (
    <li>
      ...
      >
        ...
        <div className={`text-xs ${props.rctn.clck ? 'text-gray-900 dark:text-gray-50' : 'text-gray-400 dark:text-gray-500'} group-hover:text-gray-900 dark:group-hover:text-gray-50`}>
          {props.rctn.amnt}
        </div>
      </button>
    </li>
